                ...
                if len(n_gram_word_list[0].split(' ')) == 1:
                    ...
                    if kw_list.index(min_score_word) == 0:
                        ...
                        if temporal_kw in relevant_words_array:
                            try:
                                if relevant_words_array.index(temporal_kw) > relevant_words_array.index(
                                        final_splited_text[-1] + ' ' + temporal_kw) and not re.findall(
                                        self.highlight_pre, final_splited_text[-1]):
